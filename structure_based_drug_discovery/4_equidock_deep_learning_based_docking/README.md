...
**대표 케이스 (C-RMSD = 13.83 Å)**

![대표 케이스](images/image1.png)

> 빨간(예측)과 초록(실제)이 대부분 겹침 → 결합 포켓 예측 성공  
> 일부 말단 루프 구간에서 편차 → C-RMSD 13.3Å의 원인

---

**최선 케이스 (C-RMSD = 3.09 Å)**

![최선 케이스](images/image2.png)

> 예측(빨강)과 실제(초록)가 거의 완벽히 일치 → 결합 포켓 및 전체 구조 예측 성공

---

**최악 케이스 (C-RMSD = 36.94 Å)**

![최악 케이스](images/image3.png)

> 예측이 실제 결합 위치와 크게 벗어남 → Rigid-body 가정의 한계, Induced fit 미반영
